...
#ifndef MEDIA_SELECTOR_DEPRECATED_WITH_REPLACEMENT
#   define MEDIA_SELECTOR_DEPRECATED_WITH_REPLACEMENT(msg, replacement) __attribute__((deprecated(msg, replacement)))
#endif
