...
@interface BBCSMPLocalPlayerItemProviderBuilder()

@property (nonatomic, strong, nullable) id<BBCSMPLocalDecoderFactory> decoderFactory;
...
- (instancetype)withDecoderFactory:(id<BBCSMPLocalDecoderFactory>)decoderFactory
{
...
- (void)setValuesOnProvider:(BBCSMPLocalPlayerItemProvider*)provider{
    ...
    provider.videoTrackSubscriber = _videoTrackSubscriber;
    if (_decoderFactory) {
        provider.decoderFactory = _decoderFactory;
    }
}
