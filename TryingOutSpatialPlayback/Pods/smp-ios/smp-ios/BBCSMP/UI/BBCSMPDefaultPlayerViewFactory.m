...
{
    UIView<BBCSMPView>* view = [self createViewWithContext:context usingConfiguration:context.fullscreenConfiguration];
    BBCSMPFullscreenViewController *viewController = [[BBCSMPFullscreenViewController alloc] initWithSMPView:view];
...
- (UIView<BBCSMPView>*)createViewWithContext:(BBCSMPViewContext *)context usingConfiguration:(id<BBCSMPUIConfiguration>)configuration
{
    BBCSMPPlayerView* view = [[BBCSMPPlayerView alloc] initWithFrame:context.frame
                                       ...
                                       safeAreaGuideProvidingFactory:_safeAreaGuideProvidingFactory
                                             backgroundStateProvider:[[BBCSMPBackgroundManagerNotificationAdapter alloc] init]
