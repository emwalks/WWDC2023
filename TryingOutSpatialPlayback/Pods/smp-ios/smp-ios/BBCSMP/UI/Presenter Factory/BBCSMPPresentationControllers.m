...
- (instancetype)initWithContext:(BBCSMPPresentationContext*)context
{
    ...
    if(self) {
        ...
        _videoSurfaceController = [[BBCSMPVideoSurfaceController alloc] initWithVideoSurfaceManager:context.videoSurfaceManager view:context.view viewControllerLifecycleCoordinator:_viewControllerLifecycleCoordinator];
    }
