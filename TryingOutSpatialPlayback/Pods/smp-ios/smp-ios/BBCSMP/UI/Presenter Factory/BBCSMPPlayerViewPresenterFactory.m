...
- (void)buildPresentersWithContext:(BBCSMPPresentationContext *)context
{
    ...
    BBCSMPPlayerPluginEnviroment* pluginEnviroment = [[BBCSMPPlayerPluginEnviroment alloc] initWithPlayer:context.player view:context.view chromeSuppression:controllers.chromeVisibilityCoordinator navigationCoordinator:context.navigationCoordinator playerViewController:context.fullscreenViewController videoSurfaceManager:context.videoSurfaceManager];
