...
@implementation BBCSMPPlayerViewBuilder {
    ...
    UIViewController<BBCSMPVideoTrackSubscriber> *_builtViewController;
...
- (UIView<BBCSMPVideoTrackSubscriber> *)buildView
{
    ...
    if(_fullscreenPresenter) {
        ...
        _navigationCoordinator = [[BBCSMPNavigationCoordinator alloc] initWithPlayer:_player videoSurfaceManager:_videoSurfaceManager];
    }
...
- (UIViewController<BBCSMPVideoTrackSubscriber> *)buildViewController
{
...
- (void)prepareViewControllerProvidingForPresentationMode:(BBCSMPPresentationMode)presentationMode
{
    ...
    _navigationCoordinator = [[BBCSMPNavigationCoordinator alloc] initWithPlayer:_player
                                                         ...
                                                         viewControllerProviding:_viewControllerProviding
                                                             videoSurfaceManager:_videoSurfaceManager];
    presentationContext.navigationCoordinator = _navigationCoordinator;
    
    if(presentationMode == BBCSMPPresentationModeFullscreen) {
        _builtViewController = (UIViewController<BBCSMPVideoTrackSubscriber> *) [_viewControllerProviding createViewController];
