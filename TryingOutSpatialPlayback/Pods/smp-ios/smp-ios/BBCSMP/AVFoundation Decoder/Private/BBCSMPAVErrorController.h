...
- (instancetype)initWithEventBus:(BBCSMPEventBus *)eventBus mediaServicesResetDelegate: (id<BBCSMPMediaServicesResetDelegate> )mediaServicesResetDelegate NS_DESIGNATED_INITIALIZER;
