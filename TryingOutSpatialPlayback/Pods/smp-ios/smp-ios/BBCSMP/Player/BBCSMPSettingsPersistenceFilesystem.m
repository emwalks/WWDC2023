...
- (void)loadSettingsOrCreateDefaultsWith:(BOOL)unsetDefaultValue
{
    if ([[NSFileManager defaultManager] fileExistsAtPath:self.settingsFilePath]) {
        ...
        self.settingsDictionary = [NSMutableDictionary dictionaryWithDictionary:@{BBCSMPDefaultSettingsStoreSubtitlesActiveKey : [NSNumber numberWithBool:unsetDefaultValue] }];
    }
}
